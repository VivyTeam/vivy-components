        ...
        <div className="container">
          ...
          <div className="box">
            ...
            <p>
              ...
              positively to the system at scale. There should be no
              isolated features or outliers.
            </p>
          </div>
          <div className="box">
            <h2>Universal</h2>
            <p>
              Vivy is used by a wide global community.
              Our products and visual language should be welcoming and accessible.
            </p>
          </div>
          <div className="box">
            <h2>Iconic</h2>
          ...
          <div className="box">
            ...
            <p>
              Our use of motion breathes life into our products,
              and allows us to communicate with users in easily understood ways.
            </p>
          </div>
        </div>
      </Col>
