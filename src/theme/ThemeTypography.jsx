...
export default function ThemeTypography() {
     return (
      ...
      <div className="container">
        ...
        <br />
        <small>TTNorms-Regular, 0.9375rem (15px), #575756, line-height: 20px</small>
        <small style={{color:'red', display:'block'}}>Small and hard to read for many people so use with caution</small>
        <br />
